...
//}
//
//func BenchmarkChain_CoingodTx_NoAsset_BASE(b *testing.B) {
//	benchInsertChain(b, 1, 0, "")
//}
//
//func BenchmarkChain_5000CoingodTx_NoAsset_BASE(b *testing.B) {
//	benchInsertChain(b, 5000, 0, "")
//}
//
//func BenchmarkChain_5000CoingodTx_1Asset_BASE(b *testing.B) {
//	benchInsertChain(b, 5000, 1, "")
//}
//
//// standard Transaction
//func BenchmarkChain_CoingodTx_NoAsset_P2PKH(b *testing.B) {
//	benchInsertChain(b, 1000, 0, "P2PKH")
//}
//
//func BenchmarkChain_CoingodTx_1Asset_P2PKH(b *testing.B) {
//	benchInsertChain(b, 1000, 1, "P2PKH")
//}
//
//func BenchmarkChain_CoingodTx_NoAsset_P2SH(b *testing.B) {
//	benchInsertChain(b, 100, 0, "P2SH")
//}
//
//func BenchmarkChain_CoingodTx_1Asset_P2SH(b *testing.B) {
//	benchInsertChain(b, 100, 1, "P2SH")
//}
//
//func BenchmarkChain_CoingodTx_NoAsset_MultiSign(b *testing.B) {
//	benchInsertChain(b, 100, 0, "MultiSign")
//}
//
//func BenchmarkChain_CoingodTx_1Asset_MultiSign(b *testing.B) {
...
//	utxos := []*account.UTXO{}
//	for i := 0; i < num; i++ {
//		utxo := MockSimpleUtxo(uint64(i), consensus.CGAssetID, amount, ctrlProg)
...
//}
//
//func CreateTxBuilder(baseUtxo *account.UTXO, coingodServiceFlag bool, signer *signers.Signer) (*txbuilder.TemplateBuilder, error) {
...
//
//	// if the coingod is the service charge, didn't need to add the output
//	if coingodServiceFlag {
...
//	coingodServiceFlag := false
//	if otherUtxos == nil || len(otherUtxos) == 0 {
//		coingodServiceFlag = true
//	}
//
//	tplBuilder, err := CreateTxBuilder(baseUtxo, coingodServiceFlag, signer)
//	if err != nil {
//		return nil, err
//	}
//
...
//		}
//
//		utxo := MockSimpleUtxo(0, consensus.CGAssetID, 1000000000, controlProg)
