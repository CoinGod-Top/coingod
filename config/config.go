...
func DefaultDataDir() string {
	...
	case "darwin":
		...
		oldPath := filepath.Join(home, "Library", "Coingod")
		newPath := filepath.Join(home, "Library", "Application Support", "CoinGod")
		...
		return newPath
	case "windows":
		return filepath.Join(home, "AppData", "Roaming", "CoinGod")
	default:
		return filepath.Join(home, ".coingod")
	}
}
