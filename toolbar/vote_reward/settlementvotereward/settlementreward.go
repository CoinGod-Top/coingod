...
import (
	...
	"coingod/consensus"
	"coingod/errors"
	"coingod/toolbar/apinode"
	"coingod/toolbar/common"
	"coingod/toolbar/vote_reward/config"
)
...
func (s *SettlementReward) Settlement() error {
	...
	// send transactions
	return s.node.BatchSendCG(s.rewardCfg.AccountID, s.rewardCfg.Password, s.rewards, data)
}
